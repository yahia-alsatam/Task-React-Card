    ...
    <>
      ...
      <div className="ParentDiv ">
        {Products.map((Product) => (
          <div
            key={Product.id}
            className=" flex flex-col justify-between w-full CardDiv bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 max-[510px]:w-full"
          >
            <a href="#">
              <img
            ...
            <div className="px-5 pb-5 title">
              ...
              <div className="flex items-center mt-2.5 mb-5">
                ...
                <span className="bg-teal-100 text-teal-500 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-teal-300 dark:text-teal-400 ms-3">
                  5.0
                </span>
              </div>
